...
public class DTOUtils
{
    ...
    public static Ticket getFromDTO(DTOTicket dto)
    {
        return new Ticket(dto.getId(), getFromDTO(dto.getClient()), getFromDTO(dto.getFlight()));
    }

    public static DTOTicket getDTO(Ticket ticket)
    {
        return new DTOTicket(ticket.getId(), getDTO(ticket.getClient()), getDTO(ticket.getFlight()));
    }
