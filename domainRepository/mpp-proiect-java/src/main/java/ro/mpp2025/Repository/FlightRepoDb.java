...
public class FlightRepoDb extends AbstractDbRepo<Integer, Flight> implements FlightRepo {
    ...
    protected PreparedStatement getSaveStatement(Connection connection, Flight entity) throws SQLException {
        ...
        var result = connection.prepareStatement("INSERT INTO Flight VALUES (?, ?, ?, ?, ?)");
        result.setInt(1, entity.getId());
        result.setString(2, entity.getDestination());
        result.setTimestamp(3, Timestamp.valueOf(entity.getDeparture()));
        result.setInt(4, entity.getSeats());
        result.setString(5, entity.getLocation());
        return result;
    }
    @Override
